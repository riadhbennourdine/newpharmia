...
const CampaignsManager: React.FC = () => {
  ...
  const toggleActive = async (campaign: AdCampaign) => {
    try {
      await campaignService.updateCampaign(campaign._id as string, {
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-6">
                ...
                <div className="flex items-center">
                  ...
                  />
                  <label className="ml-2 block text-sm text-gray-900 font-bold text-yellow-600">
                    Sponsor Premium (Sidebar)
                  </label>
                </div>
              </div>
            </div>
