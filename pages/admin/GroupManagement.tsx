...
import { PlusCircleIcon, PencilIcon, TrashIcon, EyeIcon } from '../../components/Icons';
        ...
        <table className="min-w-full divide-y divide-gray-200">
            ...
            {groupsToRender.map((group) => {
                ...
                <tr key={group._id as string}>
                    ...
                    <button onClick={() => handleOpenDetailsModal(group)} className="text-blue-600 hover:text-blue-900 mr-4" title="Voir détails">
