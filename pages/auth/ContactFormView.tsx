...
const ContactFormView: React.FC = () => {
    ...
    return (
        <div className="container mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-center text-gray-800 mb-10">Contactez-nous</h1>
            <form onSubmit={handleSubmit} className="max-w-xl mx-auto bg-white p-8 rounded-lg shadow-md">
                ...
                <div className="mb-4">
                    <label htmlFor="attachment" className="block text-sm font-medium text-gray-700">Pièce jointe (preuve de paiement)</label>
                    <input
                        type="file"
                        id="attachment"
