...
import {
  ...
  CheckCircleIcon,
  DocumentTextIcon,
} from '../components/Icons'; // Import DocumentTextIcon
      ...
      const fetchTeam = async () => {
        try {
          const response = await fetch(
            `/api/users/pharmacists/${user._id}/team`,
            {
              headers: {
  ...
  return (
    <div className="bg-slate-50 min-h-screen">
      <div className="container mx-auto p-4 sm:p-6 lg:p-8">
        <h1 className="text-3xl font-bold text-slate-800 mb-8 font-poppins">
          Mon Profil
        </h1>
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg mb-8">
          ...
          {!isEditing ? (
            ...
            <form onSubmit={handleProfileUpdate}>
              ...
              <button
                type="submit"
                className="mt-6 flex items-center bg-teal-600 text-white px-4 py-2 rounded-lg shadow-md hover:bg-teal-700 transition"
              >
        ...
        <div className="bg-white p-6 rounded-xl shadow-lg mb-8">
          ...
          <form onSubmit={handlePasswordUpdate}>
            ...
            <button
              type="submit"
              className="mt-6 bg-teal-600 text-white px-4 py-2 rounded-lg shadow-md hover:bg-teal-700 transition"
            >
              ...
              {invoices
                ...
                .map((invoice) => (
                  <li
                    ...
                    className="border border-slate-200 rounded-lg p-4 flex justify-between items-center shadow-sm"
                  >
                    <div>
                      <p className="font-semibold text-slate-800 font-roboto">
                        Facture #{invoice._id?.toString().slice(-6)}
                      </p>
        ...
        {user.role === 'PHARMACIEN' && (
          <div className="bg-white p-6 rounded-xl shadow-lg">
            ...
            {team.length > 0 ? (
              <ul className="space-y-3">
                {team.map((member) => (
                  <li
                    ...
                    className="border-b border-slate-200 pb-3 flex items-center"
                  >
              ...
              <p className="text-slate-500 font-roboto">
                Vous n'avez pas encore de membres dans votre équipe.
              </p>
            )}
          </div>
        )}
