...
const ResourceEditor: React.FC = () => {
  ...
  const [webinarGroupFilter, setWebinarGroupFilter] = useState<
    WebinarGroup | 'all'
  >('all');
        ...
        .then((data) => {
          if (data.summary) {
            ...
            setResourcePage((prev) => ({
              ...prev,
              subtitle: selectedWebinar.description,
            }));
          }
        })
        .catch(() => {
    ...
    <>
      <div className="container mx-auto p-6">
        <h1 className="text-3xl font-bold mb-6">
          {id ? 'Modifier' : 'Créer'} une page de ressources
        </h1>
        {error && (
        ...
        >
          {!id && (
            <div className="space-y-4 p-4 border rounded-md bg-slate-50">
              <h3 className="text-lg font-medium text-gray-900">
                Hériter d'un webinaire (Optionnel)
              </h3>
              <div>
                <label
                  htmlFor="webinarGroup"
                ...
                <select
                  id="webinarGroup"
                  onChange={(e) =>
                    setWebinarGroupFilter(
                      e.target.value as WebinarGroup | 'all',
                    )
                  }
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                name="coverImageUrl"
                id="coverImageUrl"
                value={resourcePage.coverImageUrl || ''}
                onChange={handleChange}
                className="mt-1 block w-full p-2 border border-gray-300 rounded-md"
              />
              <button
                ...
                className="mt-1 px-4 py-2 bg-blue-100 text-blue-700 rounded-md text-sm hover:bg-blue-200"
              >
                Galerie
              </button>
            </div>
            {resourcePage.coverImageUrl && (
              <img
                src={resourcePage.coverImageUrl}
                alt="Aperçu"
          ...
          <div className="space-y-4">
            ...
            <button
              type="button"
              onClick={addResource}
              className="px-4 py-2 bg-slate-200 text-slate-800 rounded-md hover:bg-slate-300 text-sm font-semibold"
            >
          ...
          <div className="flex justify-end gap-4 pt-4 border-t">
            ...
            <button
              ...
              className="bg-teal-600 text-white px-6 py-2 rounded-md hover:bg-teal-700 disabled:bg-gray-400 font-semibold"
            >
