...
const ActivateAccountView = lazy(
  () => import('./pages/auth/ActivateAccountView'),
);
const ContactFormView = lazy(() => import('./pages/auth/ContactFormView'));
const ProfileCompletionView = lazy(
  () => import('./pages/auth/ProfileCompletionView'),
);
...
const ClientDetailPage = lazy(
  () => import('./pages/admin/crm/ClientDetailPage'),
);
...
const WebinarAdminManager = lazy(
  () => import('./pages/admin/WebinarAdminManager'),
);
...
const DermoFicheGenerator = lazy(
  () => import('./pages/apps/DermoFicheGenerator'),
);
          ...
          >
            <Routes>
              ...
              <Route element={<AppLayout />}>
                ...
                <Route
                  path="/apercu-memofiche"
                  element={<MemoFichePreview />}
                />
              ...
              <Route element={<LoggedInRoute />}>
                ...
                <Route
                  path="/read-fiches/:userId"
                  element={<ReadFichesPage />}
                />
                <Route
                  path="/quiz-history/:userId"
                  element={<QuizHistoryPage />}
                />
                <Route
                  path="/complete-profile"
                  element={<ProfileCompletionView />}
                />
                ...
                <Route element={<FormateurOrAdminRoute />}>
                  <Route
                    path="/edit-memofiche"
                    element={<MemoFicheEditorPage />}
                  />
                  <Route
                    path="/edit-memofiche/:id"
                    element={<MemoFicheEditorPage />}
                  />
                </Route>
                ...
                <Route element={<AdminOnlyRoute />}>
                  ...
                  <Route
                    path="/apps/dermo/simulation/:id"
                    element={<DermoSimulationPage />}
                  />
                  <Route
                    path="/apps/dermoguide-generator"
                    element={<DermoFicheGenerator />}
                  />{' '}
                  <Route
                  ...
                  />
                  <Route
                    path="/admin/webinar-admins"
                    element={<WebinarAdminManager />}
                  />
