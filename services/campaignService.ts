...
export const campaignService = {
    ...
    // Create a campaign
    createCampaign: async (campaign: Omit<AdCampaign, '_id' | 'createdAt'>): Promise<AdCampaign> => {
        const response = await fetch(API_URL, {
            method: 'POST',
            headers: getHeaders(),
    ...
    // Update a campaign
    updateCampaign: async (id: string, updates: Partial<AdCampaign>): Promise<AdCampaign> => {
