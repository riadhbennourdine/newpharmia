...
const lineFromDB = "**Topiques locaux** Crèmes, pommades, suppositoires anti-hémorroïdaires:";
...
keywordsFromDB.forEach(keyword => {
    ...
    console.log(`Keyword: "${keyword}" 	-> Normalized: "${normalizedKeyword}" 	-> Match: ${isMatch}`);
});