...
const webinars = [
  {
    ...
    description:
      'Session CROP Tunis : Pharmacie vétérinaire - focus volailles et protocoles de vaccination.',
  ...
  },
  {
    ...
    description:
      'Session de révision générale et session interactive de questions-réponses.',
    presenter: 'Ph Riadh Barhoumi',
    group: 'CROP Tunis',
    publicationStatus: 'PUBLISHED',
  },
  {
    ...
    description:
      'Évaluation écrite des connaissances acquises durant le cycle.',
    presenter: 'Ph Riadh Barhoumi',
    group: 'CROP Tunis',
    publicationStatus: 'PUBLISHED',
  },
