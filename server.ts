...
import fs from 'fs';
import { authenticateToken, AuthenticatedRequest, checkRole, softAuthenticateToken } from './server/authMiddleware.js';
...
if (!process.env.JWT_SECRET) {
    console.error('CRITICAL WARNING: JWT_SECRET is not defined in environment variables. Authentication will fail.');
}
