...
export const BookCheckIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
  ...
  >
    ...
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M16.5 9.75l-3.75 3.75-1.5-1.5"
    />
  </svg>
);
...
export const MicIcon = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12 18.75a6 6 0 0 0 6-6v-1.5m-6 7.5a6 6 0 0 1-6-6v-1.5m12-3a6 6 0 0 0-12 0v1.5a6 6 0 0 0 12 0v-1.5Z"
    />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12 18.75a6 6 0 0 0 6-6v-1.5M12 12.75a3 3 0 0 1-3-3v-1.5a3 3 0 0 1 6 0v1.5a3 3 0 0 1-3 3Z"
    />
  </svg>
);
...
export const MicOffIcon = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12 12.75a3 3 0 0 1-3-3v-1.5a3 3 0 0 1 6 0v1.5a3 3 0 0 1-3 3Z"
    />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const SparklesIcon: React.FC<{ className?: string }> = ({
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.293 2.293a1 1 0 010 1.414L10 12l-2 2-2.828-2.828a1 1 0 010-1.414L7.464 7.464A1 1 0 018.88 7.121L11 9.243l1.172-1.171a1 1 0 011.414 0L14.293 9.293l1.414-1.414M17 13l2.293 2.293a1 1 0 010 1.414L15 21l-2-2-2.828-2.828a1 1 0 010-1.414l1.707-1.707a1 1 0 011.414 0z"
    />
  </svg>
);
...
export const CapsuleIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12.75 3.375V12m0 8.625v-8.625m0 8.625H9.375m3.375 0H16.5m-3.375-8.625V3.375m0 0L9.375 6m3.375-2.625L16.5 6m-3.375 14.625L9.375 18m3.375 2.625L16.5 18m-6.375-3.375h3.75m-3.75 0h-3.75m3.75 0v3.75m0-3.75v-3.75m-3.75 0h3.75m-3.75 0h-3.75"
    />
  </svg>
);
...
export const ArrowUturnLeftIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
...
export const ArrowLeftCircleIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M11.25 9l-3 3m0 0l3 3m-3-3h7.5M21 12a9 9 0 1 1-18 0 9 9 0 0118 0z"
    />
  </svg>
);
...
export const ArrowRightCircleIcon: React.FC<{ className?: string }> = ({
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12.75 15l3-3m0 0l-3-3m3 3h-7.5M21 12a9 9 0 1 1-18 0 9 9 0 0118 0z"
    />
  </svg>
);
...
export const PlusCircleIcon: React.FC<{ className?: string }> = ({
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12 9v6m3-3H9m12 0a9 9 0 1 1-18 0 9 9 0 0118 0z"
    />
  </svg>
);
...
export const TrendingUpIcon: React.FC<{ className?: string }> = ({
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M2.25 18L9 11.25l4.328 4.328 7.5-7.5"
    />
  </svg>
);
...
export const UserGroupIcon: React.FC<{ className?: string }> = ({
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962a3.75 3.75 0 015.25 0m-5.25 0a3.75 3.75 0 00-5.25 0M15 21a3 3 0 01-6 0v-1.5a3 3 0 013-3h.015a3 3 0 013 3v1.5z"
    />
  </svg>
);
...
export const ShareIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M7.217 10.907a2.25 2.25 0 100 4.186 2.25 2.25 0 000-4.186zM12 15.75a2.25 2.25 0 100 4.186 2.25 2.25 0 000-4.186zM16.783 4.093a2.25 2.25 0 100 4.186 2.25 2.25 0 000-4.186zM12.75 6.168L9.32 8.49a2.25 2.25 0 000 3.02l3.43 2.322"
    />
  </svg>
);
...
export const ShoppingCartIcon: React.FC<{ className?: string }> = ({
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 0 0-3 3h15.75m-12.75-3h11.218c.51 0 .962-.343 1.087-.835l1.823-6.423a.75.75 0 0 0-.676-.928H5.618M15 19.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 013 0Zm-7.5 0a1.5 1.5 0 1 1-3 0 1.5 1.5 0 013 0Z"
    />
  </svg>
);
...
export const EditIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 19.5l-4.243 1.243 1.243-4.243L16.862 4.487z"
    />
  </svg>
);
...
// New icons for Webinar resources
export const PlayIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    ...
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M15.975 9.75l-6.574 4.072A.75.75 0 018.5 13.5V6.75a.75.75 0 011.101-.62L15.975 9.75z"
    />
  </svg>
);
...
export const DocumentTextIcon: React.FC<{ className?: string }> = ({
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375H8.25m0 0L6.9 7.75M8.25 10.875L6.9 12.375m1.35-1.5l1.409 1.409a2.25 2.25 0 003.182 0l5.159-5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 003.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5H3.75A1.5 1.5 0 002.25 6v12a1.5 1.5 0 001.5 1.5zm10.5-11.25h.008v.008h-.008V8.25zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z"
    />
  </svg>
);
...
export const BeakerIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M9.75 3.104v1.244c0 .462.184.906.512 1.234l1.734 1.734c.328.328.512.772.512 1.234v1.244m.027 11.168c-.027.047-.054.094-.08.14a.75.75 0 0 1-1.294-.749c.026-.046.053-.093.08-.14m1.294.749a.75.75 0 1 1-1.294-.749m1.294.749L15 15.75m-3 0V4.5m0 11.25L9 15.75M3 6h18M6.75 6v2.25C6.75 9.354 7.646 10.25 8.75 10.25h6.5c1.104 0 2-.896 2-2V6M8 17.25h8"
    />
  </svg>
);
...
export const SimulationIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
...
export const PrinterIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M6.72 13.829c-.24.03-.48.062-.72.096m.72-.096a42.415 42.415 0 0110.56 0m-10.56 0L6.34 18m10.94-4.171c.24.03.48.062.72.096m-.72-.096L17.66 18m0 0l.229 2.523a1.125 1.125 0 01-1.12 1.227H7.231c-.662 0-1.18-.568-1.12-1.227L6.34 18m11.319 0a1.125 1.125 0 00-1.12-1.227H7.231c-.662 0-1.18.568-1.12 1.227m11.319 0H12m-5.66 4.171l-.229-2.523m0 0a2.25 2.25 0 012.25-2.25h1.372a2.25 2.25 0 012.25 2.25m-6.115 0a2.25 2.25 0 002.25 2.25h1.372a2.25 2.25 0 002.25-2.25m0 0a2.25 2.25 0 012.25-2.25h1.372a2.25 2.25 0 012.25 2.25m0 0a2.25 2.25 0 002.25 2.25h1.372a2.25 2.25 0 002.25-2.25m-6.115 0a2.25 2.25 0 012.25-2.25h1.372a2.25 2.25 0 012.25 2.25m0 0a2.25 2.25 0 002.25 2.25h1.372a2.25 2.25 0 002.25-2.25M12 2.25v.001M12 5.25v.001M12 8.25v.001M12 11.25v.001M6.34 12l-4.171-4.171a1.125 1.125 0 010-1.59L6.34 2.25m11.319 0l4.171 4.171a1.125 1.125 0 010 1.59L17.66 12m0 0l4.171 4.171a1.125 1.125 0 010 1.59l-4.171 4.171m-11.319 0l-4.171-4.171a1.125 1.125 0 010-1.59L6.34 12"
    />
  </svg>
);

export const DocumentArrowDownIcon: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
