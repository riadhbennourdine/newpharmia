...
const BankTransferModal: React.FC<BankTransferModalProps> = ({ onClose, planName, basePrice, isAnnual }) => {
  const VAT_RATE = 0.19;
            ...
            <div className="bg-teal-50 border border-teal-200 rounded-lg p-6 mb-6">
                ...
                <div className="space-y-2">
                    <div className="flex justify-between">
                        ...
                        <span className="font-semibold text-slate-800">{planName} ({isAnnual ? 'Annuel' : 'Mensuel'})</span>
                    </div>
                    <div className="flex justify-between">
                        <span className="text-slate-600">Montant HT:</span>
                        <span className="font-semibold text-slate-800">{totalAmount.toFixed(3)} TND</span>
                    </div>
                    <div className="flex justify-between">
