...
const AssignFicheToGroupModal: React.FC<AssignFicheToGroupModalProps> = ({ fiche, onClose }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`/api/admin/groups/${selectedGroupId}/assign-fiche`, {
        method: 'POST',
