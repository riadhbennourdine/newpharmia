      ...
      <div>
        ...
        <div className="mt-1 flex items-center gap-2">
          <Input
            ...
            name="coverImageUrl"
            id="coverImageUrl"
            value={getAbsoluteImageUrl(caseStudy.coverImageUrl)}
            onChange={handleChange}
            className="flex-grow"
          />
          <button
            ...
            onClick={() =>
              openImageModal((url) =>
                setCaseStudy((prev) => ({ ...prev, coverImageUrl: url })),
              )
            }
      ...
      {caseStudy.coverImageUrl && (
        <div>
          <Label htmlFor="coverImagePosition">
            Position de l'image de couverture
          </Label>
          <Select
            name="coverImagePosition"
            id="coverImagePosition"
            value={caseStudy.coverImagePosition || 'middle'}
            onChange={handleChange}
          >
