...
interface FlashcardsEditorProps {
    caseStudy: CaseStudy;
    handleItemChange: (listName: 'flashcards' | 'quiz' | 'glossary', index: number, field: string, value: string | number) => void;
    handleAddItem: (listName: 'flashcards' | 'quiz' | 'glossary') => void;
    handleRemoveItem: (listName: 'flashcards' | 'quiz' | 'glossary', index: number) => void;
}
...
interface QuizEditorProps extends FlashcardsEditorProps {
    handleQuizOptionChange: (qIndex: number, oIndex: number, value: string) => void;
}
